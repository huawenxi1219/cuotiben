            ...
            def open_settings(e):
                try:
                    ...
                    try:
                        ...
                        page.snack_bar = ft.SnackBar(ft.Text("请手动进入系统设置 -> 应用 -> 智能错题笔记助手 -> 权限 -> 开启存储权限"))
                        page.snack_bar.open = True
                        page.update()
            ...
            def show_permission_dialog():
                def retry_check(e):
                    ...
                    if has_storage_permission():
                        page.snack_bar = ft.SnackBar(ft.Text("✅ 权限已开启，请重启应用"))
                        page.snack_bar.open = True
                        page.update()
                    else:
