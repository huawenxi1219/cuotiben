...
# ==================== 路径配置（桌面默认，手机端自动切换） ====================
DATA_DIR = r"C:\Users\黄\Desktop\错题笔记助手"
...
def init_data_paths(page: ft.Page):
    global DATA_DIR, IMAGES_DIR, VIDEOS_DIR, DOCS_DIR, ERRORS_FILE, NOTES_FILE, RECYCLE_FILE
    global REVIEW_CARDS_FILE, TASKS_FILE, AI_CONFIG_FILE, USER_PROFILE_FILE, CUSTOM_SKILL_FILE
    global CHAT_HISTORY_DIR, CONTENT_LIB_DIR, NEW_WORDS_FILE
...
只返回JSON数组，不要其他文字。"""
    ...
    def build_subject_left_panel(subj):
        ...
        for s in subjects:
            is_selected = s == subj
            btn = ft.Container(
                content=ft.Text(s, size=16, weight=ft.FontWeight.BOLD,   # 统一加粗
